...
# Step 5:
# Start the Clo
sudo /opt/aws/amazon-cloudwatch-agent/bin/amazon-cloudwatch-agent-ctl -a fetch-config -m ec2 -s -c file:configuration-file-path # Edit the configuration-file-path to where itis stored
